...
The **ensembleDownscaleR** package provides software for Bayesian ensemble averaging of $\text{PM}_{2.5}$ geostatistical downscalers. The package is fully described [here](https://doi.org/10.3390/rs17111941). 
